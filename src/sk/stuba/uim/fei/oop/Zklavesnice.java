...
public class Zklavesnice {
    ...
    public static char readChar(int numberOfTries, String failureText) {
        return repeatInput(numberOfTries, failureText, c -> c == (char) 0, Zklavesnice::readChar);
    }
    ...
    public static String readString(int numberOfTries, String failureText) {
        return repeatInput(numberOfTries, failureText, String::isEmpty, Zklavesnice::readString);
    }
    ...
    public static int readInt(int numberOfTries, String failureText) {
        return repeatInput(numberOfTries, failureText, i -> i == Integer.MIN_VALUE, Zklavesnice::readInt);
    }
    ...
    public static double readDouble(int numberOfTries, String failureText) {
        return repeatInput(numberOfTries,failureText, d -> d == Double.MIN_VALUE, Zklavesnice::readDouble);
    }
